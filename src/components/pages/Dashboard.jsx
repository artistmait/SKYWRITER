  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-6 py-16">
        <h2 className="text-5xl font-extrabold font-display text-gray-900 mb-6">
          Welcome back to <span className="text-yellow-700">SkyWriter</span>
        </h2>
        <p className="text-lg text-gray-600 max-w-2xl mb-10">
          SkyWriter helps you create, organize, and bring your ideas to life.
          Click below to get started with your workspace.
        </p>

        <Link to="/main">
          <button className="px-10 py-4 bg-black text-white font-display text-2xl rounded-full hover:bg-yellow-700 transition-all duration-300 shadow-lg">
            Try SkyWriter
          </button>
        </Link>
      </main>
